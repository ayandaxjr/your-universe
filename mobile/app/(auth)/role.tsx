      ...
      <SafeAreaView style={styles.fill}>
        <View style={styles.content}>
          ...
          <GameCard accent="purple">
            <Text style={[styles.cardCopy, { color: colors.text2 }]}>
...
const styles = StyleSheet.create({
  ...
  half: { flex: 1 },
  cardCopy: { fontFamily: fonts.sans, fontSize: 14, lineHeight: 22 },
  footer: { marginTop: "auto", textAlign: "center", fontSize: 12, fontFamily: fonts.sansMedium },
});
